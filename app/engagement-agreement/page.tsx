...
export const metadata: Metadata = {
  title: "Limited Scope Engagement Agreement Preview | EZ TODD by EZ Law",
  description:
    "Preview representative limited-scope engagement terms for the EZ TODD deed product.",
};
    ...
    <>
      ...
      <main className="bg-black text-white">
        <section className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/60">
              This page shows representative agreement sections. The final agreement
              and acceptance process will be sent directly by EZ Law after attorney review.
            </p>
          </div>
        </section>
        ...
        <section className="px-4 pb-16 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-6xl gap-6">
            ...
            <p className="rounded-md border border-white/10 bg-black p-4 text-sm leading-6 text-white/55">
              Online e-signature is not collected on this website yet. EZ Law will
              provide final engagement instructions after reviewing the submitted intake.
            </p>
          </div>
        </section>
        ...
        <CTASection
          ...
          body="No payment is collected on this website for the launch version."
          primaryLabel="Submit Intake"
          primaryHref="/intake"
