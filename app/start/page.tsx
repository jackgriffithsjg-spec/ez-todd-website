    ...
    <>
      ...
      <main className="bg-black text-white">
          ...
          <div className="mx-auto grid max-w-6xl gap-5 lg:grid-cols-[1fr_0.8fr]">
            ...
            <div className="grid gap-5">
              <div className="rounded-md border border-white/10 bg-white/[0.03] p-5">
                <h2 className="text-xl font-semibold tracking-normal">Texas-only service</h2>
        ...
        <CTASection
          ...
          body="Your answers are submitted to EZ Law for attorney review. No payment is collected through this website."
