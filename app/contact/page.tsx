...
export const metadata: Metadata = {
  title: "Contact Patent Ed",
  description:
    "Contact EZ Law in Lubbock, Texas for patent, trademark, business, real estate, mediation, estate planning, and civil litigation questions.",
  alternates: {
          ...
          <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1fr_0.75fr] lg:items-start">
            <div>
              ...
              <h1 className="mt-4 max-w-4xl text-4xl font-semibold tracking-normal sm:text-6xl">
                Visit with your Lubbock patent and intellectual property attorney.
              </h1>
              <p className="mt-6 max-w-2xl text-base leading-8 text-white/60 sm:text-lg">
                Reach out about patents, trademarks, copyrights, business law, real
                estate, mediation, estate planning, or civil litigation. Do not send
                confidential information until EZ Law confirms representation.
              </p>
            ...
            <aside className="rounded-md border border-white/10 bg-white/[0.03] p-6">
              ...
              <ul className="mt-5 grid gap-3 text-sm leading-6 text-white/65">
                <li>- Share the type of matter and the county or state involved.</li>
                <li>- Avoid confidential facts until representation is confirmed.</li>
                <li>- Include deadlines, hearing dates, or USPTO response dates if any.</li>
