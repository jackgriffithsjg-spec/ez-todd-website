            ...
            {submission.beneficiaries.map((beneficiary) => (
              <article key={beneficiary.name} className="rounded-md border border-white/10 bg-black p-4">
                ...
                <dl className="mt-4 grid gap-2 text-sm text-white/60">
                  ...
                  <div><dt className="font-semibold text-white">Share percentage</dt><dd>{beneficiary.sharePercentage || "Not provided"}</dd></div>
                  <div><dt className="font-semibold text-white">Alternate beneficiary</dt><dd>{beneficiary.alternate || "Not provided"}</dd></div>
                </dl>
              </article>
            ))}
          </div>
