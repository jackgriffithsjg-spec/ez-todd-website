...
const propertyItems = [
  ...
  { label: "Current deed", value: "EZ Law will request this after intake if needed." },
];
...
const beneficiaryItems = [
  ...
  { label: "Alternate beneficiary", value: "[alternate_beneficiary]" },
];
      ...
      <main className="bg-black text-white">
        <section className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-white/60">
              Use this page to understand the kind of information EZ Law reviews
        ...
        {selectedDeed ? (
          <CTASection
            ...
            body="For launch, EZ Law reviews submitted intake information before sending engagement or payment instructions."
            primaryLabel="Submit a New Intake"
            primaryHref="/intake"
